...
1. Загрузите файл **выгрузки из Метрики** — [открыть](https://metrika.yandex.ru/stat/6cfa6793-da4e-405e-8815-75076218c2af?id=51634436&period=2025-06-01%3A2025-06-11&group=day&currency=RUB&dimension_mode=tree&table=visits)  
   *(Цель — Mouseover Телефон 2. Скачайте XLSX. Период — с начала месяца до последнего воскресенья)*  
...
5. *(опционально)* Обновите плановые значения (по умолчанию — июнь 2025)
6. Нажмите **«Сгенерировать отчет»**
7. Скачайте итоговый отчет. В нем должно быть 5 листов:
   - **Совпадения**, **Звонки**, **Метрика**, **Факт**, **Статистика Директ**
""")
