...
1. Загрузите файл **выгрузки из Метрики** — [ссылка на Метрику](https://metrika.yandex.ru/stat/visits)  
   📁 Пример: [тестовая Метрика](https://github.com/Exepicode/ttk/raw/refs/heads/main/тестовый-метрика)

2. Загрузите файл **звонков из CRM** — обычно называется *«Детальный отчет»*  
   📁 Пример: [тестовый отчет звонков](https://github.com/Exepicode/ttk/raw/refs/heads/main/тестовый-Детальный%20отчет%20Июнь%201-8.xlsx)

3. Загрузите файл **из Мастера отчетов Яндекс.Директ** — [открыть отчет](https://direct.yandex.ru/dna/reports/wizard?ulogin=ttk-igc&state=157105)  
   📁 Пример: [тестовый файл Директа](https://github.com/Exepicode/ttk/raw/refs/heads/main/тестовый%20файл%20мастер%20отчетов.xlsx)

4. Заполните показатели **план-факт** в разрезе Поиск и РСЯ
5. *(опционально)* Обновите плановые значения — по умолчанию стоит план на июнь 2025 года
6. Нажмите кнопку **Сгенерировать отчет** ниже
7. Скачайте итоговый отчет
""")
